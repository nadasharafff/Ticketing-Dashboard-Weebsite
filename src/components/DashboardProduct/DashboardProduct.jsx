...
import TeamChart from "./TeamChart.json"
...
<div className="flex justify-between">
 ...
 <div>
 <h2 className='text-center text-3xl font-bold'>80</h2>
  <h4>Member</h4>
 </div>
</div>
  </div>
 <div className='w-64 lg:w-96 border border-gray-200 mt-3 me-3 ms-3'>
  <Doughnut 
    data={{
      labels: TeamChart.map((data) => data.label),
      datasets: [
        {
          
          data: TeamChart.map((data) => data.value),
          backgroundColor: [
            "rgba(121, 102, 167, 1)",
            "rgba(29, 35, 163, 1)",
            "rgba(0, 160, 153, 1)",
